...
void CAddress::Initialize()
{
	...
	FUNC_CPlayer__ExitVehicle = 0; //CUtils::FindPattern("\x0F\xB7\x96\x79\x25\x00\x00\xA1\x0C\x4C\x4F\x00\x8B\x48\x04\x0F\xB7\xFB\x57\x52\xC7\x84\x24\x34", "xxxxxxxx????xxxxxxxxxxxx") - 0x30;
	FUNC_CPlayer__SpawnForWorld = 0; //CUtils::FindPattern("\x83\x3B\x00\x74\x08\x57\x8B\xCE", "xxxxxxxx") - 0x33;
